                ...
                {!saveSuccess && (
                    <>
                        ...
                        <div className="px-8 py-6 bg-(--card-bg-lighter) border-t border-(--main-border-color) flex gap-3">
                            <button
                                onClick={onClose}
                                className="flex-1 py-3 rounded-xl font-bold text-sm border border-(--main-border-color) hover:bg-black/5 transition-colors disabled:opacity-50"
                                disabled={isSaving}
                            >
                                Cancel
                            </button>
                            <button
                                onClick={onConfirm}
                                className="flex-1 py-3 rounded-xl font-bold text-sm bg-(--active-text-color) text-white shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
