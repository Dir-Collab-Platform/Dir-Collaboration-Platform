...
```json
{
  ...
  "data": {
    ...
    "notifications": ["69563538bd45b3713e795fdd"],
    ...
    "repos": [
      {
        ...
        "languages": [
          { "label": "JavaScript", "value": 100, "color": "#f1e05a" }
        ],
        "isImported": false
      }
    ],
...
_Mounted at `/api/repos/:repoId/channels`_
...
_Mounted at `/api/repos/:repoId/channels/:channelId/messages`_
...
_Mounted at `/api/repos/:repoId/members`_
...
{
  "status": "success",
  "data": [{ "userId": { "githubUsername": "octocat" }, "role": "owner" }]
}
```
...
_Mounted at `/api/notifications`_
...
_Endpoint exposed for GitHub events_
